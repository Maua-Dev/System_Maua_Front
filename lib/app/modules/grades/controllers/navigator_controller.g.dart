...
mixin _$NavigatorController on NavigatorControllerBase, Store {
  final _$indexToShowAtom = Atom(name: 'NavigatorControllerBase.indexToShow');
  ...
  final _$toggleIndexAsyncAction =
      AsyncAction('NavigatorControllerBase.toggleIndex');

  @override
  Future<void> toggleIndex(int index) {
