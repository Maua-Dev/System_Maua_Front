  ...
  AverageModel gradesMock = AverageModel(
    ...
    averages: [
      AveragesModel(
        ...
        currentNote: 8.5,
        globalAverage: 8.8,
        tests: [GradesModel(grade: GradesEnum.P1, value: 8.0, heft: 2), GradesModel(grade: GradesEnum.P2, value: 7.5, heft: 1), GradesModel(grade: GradesEnum.P3, value: 7, heft: 2), GradesModel(grade: GradesEnum.P4, value: null, heft: 1)],
        tasks: [GradesModel(grade: GradesEnum.T1, value: 9.0, heft: 1.0), GradesModel(grade: GradesEnum.T2, value: 8.5, heft: 3.0), GradesModel(grade: GradesEnum.T3, value: null, heft: 2.0), GradesModel(grade: GradesEnum.T4, value: 9.5, heft: 3.0)],
      ),
      AveragesModel(
        ...
        currentNote: 5.5,
        globalAverage: 8.8,
        tests: [GradesModel(grade: GradesEnum.P1, value: 5.5, heft: 1), GradesModel(grade: GradesEnum.P2, value: 5.5, heft: 2)],
        tasks: [GradesModel(grade: GradesEnum.T1, value: 4.5, heft: 1.0), GradesModel(grade: GradesEnum.T2, value: 6.5, heft: 2.0)],
      ),
      AveragesModel(
        subject: 'Cálculo Diferencial e Integral II',
        parcialAverage: 8.5,
