...
void main() {
  ...
  test('[TEST] - Injeção do HelpEstagioController', () {
    Modular.get<HelpEstagioController>();
  });

  test('[TEST] - Injeção do HelpEstagioRepository', () {
    Modular.get<HelpEstagioRepository>();
  });
